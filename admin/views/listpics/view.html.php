 ...
 * @since  0.0.1
 */
class BackPicViewListpics extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		$context = "backpic.list.admin.listpic";
		...
		$this->canDo = BackPicHelper::getActions();
		...
		// Set the submenu
		BackPicHelper::addSubmenu('teachers');
	...
	protected function addToolBar()
	{
		...
		if ($this->canDo->get('core.admin')) 
		{
			...
			JToolBarHelper::preferences('com_backpic');
		}
	}
	/**
